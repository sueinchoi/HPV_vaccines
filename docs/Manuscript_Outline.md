...
- Step 4 (v3 PRIMARY) — ≥2-dose + 3-month landmark filter with matched-set integrity preserved: 36 vaccinated cases failing the dose threshold and their attached non-vaccinated participants dropped; 5 patients lost to the 3-month landmark FU filter; final v3 primary cohort **n = 934 (204 vaccinated / 730 non-vaccinated)**.
